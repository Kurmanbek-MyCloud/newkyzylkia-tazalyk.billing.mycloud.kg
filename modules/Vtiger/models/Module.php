...
class Vtiger_Module_Model extends Vtiger_Module
{
	...
	public function getModuleIcon()
	{
		...
		if ($lowerModuleName == 'boxes')
		{
			$lowerModuleName = 'potentials';
		}
		elseif ($lowerModuleName == 'potentials')
		{
			$lowerModuleName = 'products';
		}
		elseif ($lowerModuleName == 'flights')
		{
			$lowerModuleName = 'inventory';
		}
		elseif ($lowerModuleName == 'accounts')
		{
			$lowerModuleName = 'meeting';
		}
