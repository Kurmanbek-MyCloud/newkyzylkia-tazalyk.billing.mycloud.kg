...
class Vtiger_List_View extends Vtiger_Index_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
		...
		// Дополнительные данные для передачи в ListViewActions
		$extraData = isset($this->listViewEntries['extraData']) ? $this->listViewEntries['extraData'] : array();
		...
		// Добавляем наши дополнительные данные
		$viewer->assign('EXTRA_DATA', $extraData);
