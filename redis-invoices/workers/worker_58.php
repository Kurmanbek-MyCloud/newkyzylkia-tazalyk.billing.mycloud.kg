...
// ===== НАСТРОЙКИ ВОРКЕРА =====
$MP_ID = 58; // ID МП для обработки
$HANDLER_FILE = dirname(__DIR__) . '/mp_handlers/tamchy_tazasuu.php'; // Путь к файлу генерации
$HANDLER_FUNCTION = 'processTamchyTazasuuInvoice'; // Имя функции генерации
