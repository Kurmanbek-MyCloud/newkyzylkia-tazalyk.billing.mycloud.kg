...
// ===== НАСТРОЙКИ ВОРКЕРА =====
$MP_ID = 59; // ID МП для обработки
$HANDLER_FILE = dirname(__DIR__) . '/mp_handlers/tamchy_taza_aimak.php'; // Путь к файлу генерации
$HANDLER_FUNCTION = 'processTamchyTazaAimakInvoice'; // Имя функции генерации
