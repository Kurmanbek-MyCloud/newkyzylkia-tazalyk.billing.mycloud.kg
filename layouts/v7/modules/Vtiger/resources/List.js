...
Vtiger.Class("Vtiger_List_Js", {
	...
	triggerPrintPDF_for_electrocity: function () {

		var listInstance = app.controller();
		var listSelectParams = listInstance.getListSelectAllParams(true);
		var parentModule = app.getParentModuleName();

		// console.log('t', parentModule);

		if (listSelectParams) {

			var selectedIds = listSelectParams.selected_ids;
			var viewName = listSelectParams.viewname;
			var search_params = listSelectParams.search_params;

			var path = '/PrintPDF/PrintPDF_for_invoice.php';
			// window.location.href = path+'?module=Invoice&selectedIds='+selectedIds+'&viewname=' + viewName;
			var href = path + '?module=Invoice&selectedIds=' + selectedIds + '&viewname=' + viewName + '&params=' + search_params + '&_t=' + Date.now();
			window.open(href, '_blank').focus();
		}
	},
	triggerPrintPDF_for_telephone: function () {
		...
		if (listSelectParams) {
			...
			var path = '/PrintPDF/PrintPDF_for_telephone.php';
			// window.location.href = path+'?module=Invoice&selectedIds='+selectedIds+'&viewname=' + viewName;
			var href = path + '?module=Invoice&selectedIds=' + selectedIds + '&viewname=' + viewName + '&params=' + search_params;
			window.open(href, '_blank').focus();
		}
	},
