					...
					<nav class="navbar navbar-inverse border0 margin0">
						...
						<div class="container-fluid">
							...
							<ul class="nav navbar-nav">
								<!-- Модальные окна -->
							{include file="layouts/v7/modules/CustomModules/CustomModuleHeader/CustomModuleHeader.tpl"}
								<!-- /Модальные окна -->
								{foreach item=BASIC_ACTION from=$MODULE_BASIC_ACTIONS}
									...
									{/if}
								<!-- Кнопка Мониторинг Redis -->
								<!-- <li>
									<button type="button" class="btn addButton btn-default module-buttons"
									onclick="window.open('https://1.billing.mycloud.kg/redis-invoices/page_status/tabs_dashboard.php', '_blank')">
										<div class="fa fa-desktop" aria-hidden="true"></div>&nbsp;&nbsp;
										Мониторинг счетов
									</button>
								</li> -->
								<!-- Кнопка Генерация счетов -->
								<!-- <li>
									<button type="button" class="btn addButton btn-default module-buttons"
									onclick="window.open('https://1.billing.mycloud.kg/redis-invoices/invoiceModal.php?source=bulk', '_blank')">
										<div class="fa fa-list-alt" aria-hidden="true"></div>&nbsp;&nbsp;
										Генерация счетов
									</button>
								</li> -->
								</ul>
