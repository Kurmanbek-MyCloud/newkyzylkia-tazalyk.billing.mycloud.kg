...
{strip}
	...
	<nav class="navbar navbar-inverse navbar-fixed-top app-fixed-navbar">
		<div class="container-fluid global-nav">
			<div class="row">
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-8 app-navigator-container">
					<div class="row">
						<div id="appnavigator" class="col-sm-2 col-xs-2 cursorPointer app-switcher-container" data-app-class="{if $MODULE eq 'Home' || !$MODULE}fa-dashboard{else}{$APP_IMAGE_MAP[$SELECTED_MENU_CATEGORY]}{/if}">
							<div class="row app-navigator">
								<span class="app-icon fa fa-bars"style=height:70px></span>
							</div>
						</div>
				...
				<style>
					li#Leads_detailView_moreAction_LBL_ADD_TASK{
						display:none;
					}
					li#Accounts_detailView_moreAction_LBL_ADD_TASK{
						display:none;
					}
					li#Contacts_detailView_moreAction_LBL_ADD_TASK{
						display:none;
					}
					li#Potentials_detailView_moreAction_LBL_ADD_TASK{
						display:none;
					}
					button[module='Calendar']
					{
						display:none;	
					}
					...
					.custom-button {
						...
						padding: 2px; /* Убирает отступы вокруг текста внутри кнопки */
						margin-left: 5px;
						margin-top: -7px;
					}
					</style>
					...
					<ul class="nav navbar-nav">
						<li class="pr15">
							<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="/ReportFiles/Report_Choose.php" title="Отчетность" target="_blank">
									<span class="module-icon"><i class="vicon-book" title="Отчетность"></i></span>
									<div class="text_low">
										Отчетность
									</div>
								</a>
						...
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Contacts&view=List&app={$SELECTED_MENU_CATEGORY}" title="Телефония">
								<span class="module-icon"><i class="vicon-contacts" title="Телефония"></i></span>
									<div class="text_low">
										Телефония
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Telephone')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Telephone&view=List&app={$SELECTED_MENU_CATEGORY}" title="Номера телефонов">
								<span class="module-icon"><i class="vicon-contact_phone" title="Номера телефонов"></i></span>
									<div class="text_low">
										Номера тел.
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Branch')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Branch&view=List&app={$SELECTED_MENU_CATEGORY}" title="Филиалы">
								<span class="module-icon"><i class="vicon-office" title="Филиалы"></i></span>
									<div class="text_low">
										Филиалы
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Calls')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Calls&view=List&app={$SELECTED_MENU_CATEGORY}" title="Звонки">
								<span class="module-icon"><i class="vicon-phonecalls" title="Звонки"></i></span>
									<div class="text_low">
										Звонки
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Telegraph')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Telegraph&view=List&app={$SELECTED_MENU_CATEGORY}" title="Телеграф">
								<span class="module-icon"><i class="vicon-chat1" title="Телеграф"></i></span>
									<div class="text_low">
										Телеграф
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Estates')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Estates&view=List&app={$SELECTED_MENU_CATEGORY}" title="Объекты">
									<span class="module-icon"><i class="vicon-home" title="Объекты"></i></span>
									<div class="text_low">
										Объекты
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Meters')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
									<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Meters&view=List&app={$SELECTED_MENU_CATEGORY}" title="Счетчики">
									<span class="module-icon"><i class="vicon-tachometer" style="font-size:25px" title="Счетчики"></i></span>
									<div class="text_low">
										Счетчики
									</div>
									</a>
						...
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Readings')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Readings&view=List&app={$SELECTED_MENU_CATEGORY}" title="Показания">
									<span class="module-icon"><i class="vicon-droplet" style="font-size:25px" title="Показания"></i></span>
									<div class="text_low">
										Показания
									</div>
								</a>
						...
						{/if}
							{/if}
							{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Payments')}
							{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
								<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Payments&view=List&app={$SELECTED_MENU_CATEGORY}" title="Платежи">
									<span class="module-icon"><i class="vicon-payments" title="Платежи"></i></span>
									<div class="text_low">
										Платежи
									</div>
								</a>
						...
						{/if}
						{assign var=Contacts_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Invoice')}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($Contacts_MODULE_MODEL->getId())}
							<li>
								<div class="quick-link">
								<a style="display: flex; flex-direction: column; padding: 0; align-items: center;" href="index.php?module=Invoice&view=List&app={$SELECTED_MENU_CATEGORY}" title="Счета">
		...
		<style type="text/css">
			...
			.col-sm-6.col-md-3.col-lg-3.collapse.navbar-collapse.navbar-right.global-actions{
				margin: 5px 0px;
			}
			#navbar .nav.navbar-nav li{
				margin-right: 10px;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var links = document.querySelectorAll('.quick-link a');
