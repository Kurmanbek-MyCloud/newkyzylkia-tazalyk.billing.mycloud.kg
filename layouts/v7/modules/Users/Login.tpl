	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/oimo_billing_logo.png" style="padding-left: 20px; padding-right: 20px;">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue">Войти</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						<div class="group">
							<input id="fusername" type="text" name="username" placeholder="Логин" >
							<span class="bar"></span>
							<label>Логин</label>
						</div>
						<div class="group">
						...
						<div class="group">
							...
							<span>Пожалуйста, введите данные и отправьте их<a class="forgotPasswordLink pull-right" style="color: #15c;">Назад</a></span>
						</div>
					</form>
				</div>
			</div>
