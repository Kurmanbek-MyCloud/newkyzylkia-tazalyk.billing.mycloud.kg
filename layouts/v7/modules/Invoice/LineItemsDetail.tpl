    ...
    <div class="lineItemTableDiv">
        <table class="table table-bordered lineItemsTable" style="margin-top:15px">
            ...
            <th colspan="{$COL_SPAN2}" class="lineItemBlockHeader">
                ...
                {vtranslate('LBL_CURRENCY', $MODULE_NAME)} : {vtranslate($CURRENCY_INFO['currency_name'],$MODULE_NAME)}
            ...
            <tr>
                ...
                <td class="lineItemFieldName">
                    <strong>Пред. показание</strong>
                </td>

                <td class="lineItemFieldName">
                    <strong>Тек. показание</strong>
                </td>

                {if $QUANTITY_VIEWABLE}
                    <td class="lineItemFieldName">
                        <strong>Единиц</strong>
                    </td>
                {/if}
                ...
                <td class="lineItemFieldName hidden">
            ...
            {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                <tr>
                        ...
                        <div>
                            ...
                            {else}
                                <h5><a class="fieldValue"
                                       href="index.php?module={$LINE_ITEM_DETAIL["entityType$INDEX"]}&view=Detail&record={$LINE_ITEM_DETAIL["hdnProductId$INDEX"]}"
                                       target="_blank">{$LINE_ITEM_DETAIL["productName$INDEX"]}</a></h5>
                            {/if}
                        </div>
                        {if $LINE_ITEM_DETAIL["productDeleted$INDEX"]}
                    ...
                    <td>
                        {if !empty($LINE_ITEM_DETAIL["metersId$INDEX"])}
                            <a href="index.php?module=Meters&view=Detail&record={$LINE_ITEM_DETAIL["metersId$INDEX"]}">{$LINE_ITEM_DETAIL["accrualBase$INDEX"]}</a>
                        {else}
                            {$LINE_ITEM_DETAIL["accrualBase$INDEX"]}
                        {/if}
                    </td>

                    <td>
                        {if !empty($LINE_ITEM_DETAIL["prevReadingId$INDEX"])}
                            <a href="index.php?module=Readings&view=Detail&record={$LINE_ITEM_DETAIL["prevReadingId$INDEX"]}">{$LINE_ITEM_DETAIL["prevReadingDisplay$INDEX"]}</a>
                        {else}
                            {$LINE_ITEM_DETAIL["prevReadingDisplay$INDEX"]}
                        {/if}
                    </td>

                    <td>
                        {if !empty($LINE_ITEM_DETAIL["curReadingId$INDEX"])}
                            <a href="index.php?module=Readings&view=Detail&record={$LINE_ITEM_DETAIL["curReadingId$INDEX"]}">{$LINE_ITEM_DETAIL["curReadingDisplay$INDEX"]}</a>
                        {else}
                            {$LINE_ITEM_DETAIL["curReadingDisplay$INDEX"]}
                        {/if}
                    </td>
                    ...
                    <td style="white-space: nowrap;">
                        ...
                        {$ITEM_DISCOUNT_AMOUNT_VIEWABLE = false}
                        {$ITEM_DISCOUNT_PERCENT_VIEWABLE = false}
                        ...
                        <div>
                            ...
                            (-)&nbsp; <strong><a href="javascript:void(0)"
                                                 ...
                                                 title="{vtranslate('LBL_DISCOUNT',$MODULE_NAME)}"
                                                 data-content="{$DISCOUNT_INFO}">{vtranslate('LBL_DISCOUNT',$MODULE_NAME)}</a>
                                : </strong>
                        </div>
                        <div>
                        ...
                        {if $FINAL_DETAILS.taxtype eq 'individual'}
                            ...
                            <div class="individualTaxContainer">
                                ...
                                (+)&nbsp;<strong><a href="javascript:void(0)"
                                                    class="individualTax inventoryLineItemDetails" tabindex="0"
                                                    role="tooltip" id="example"
                                                    title="{vtranslate('LBL_TAX',$MODULE_NAME)}" data-trigger="focus"
                                                    data-toggle="popover"
                                                    data-content="{$INDIVIDUAL_TAX_INFO}">{vtranslate('LBL_TAX',$MODULE_NAME)} </a>
                                    : </strong>
                            </div>
                        {/if}
                    </td>
                ...
                <td width="83%">
                    <div align="right">
                        ...
                        (+)&nbsp;<strong><a class="inventoryLineItemDetails" tabindex="0" role="tooltip"
                                            ...
                                            title={vtranslate('LBL_CHARGES',$MODULE_NAME)} data-content="{$CHARGES_INFO}">{vtranslate('LBL_CHARGES',$MODULE_NAME)}</a></strong>
                    </div>
                </td>
                <td>
                    <div align="right">
            ...
            <tr>
                <td width="83%">
                    <div align="right">
                        ...
                        (+)&nbsp;<strong><a class="inventoryLineItemDetails" tabindex="0" role="tooltip"
                                            title="{vtranslate('LBL_TAXES_ON_CHARGES',$MODULE_NAME)}"
                                            data-trigger="focus" data-placement="left" data-toggle="popover"
                                            href="javascript:void(0)" id="taxesOnChargesList"
                                            data-content="{$CHARGES_TAX_INFO}">
